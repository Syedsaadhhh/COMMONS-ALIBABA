          ...
          <section className="plan-review">
            ...
            <footer className="plan-review__footer">
              <div className="persistence-notice">
                ...
                <p>
                  Project persistence is not connected yet. You can review this
                  draft, but creating the official project remains disabled.
                </p>
              </div>
              <div className="plan-review__actions">
                ...
                <Button disabled title="Project persistence is not connected yet.">
